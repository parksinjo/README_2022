...
현재시간, 컴퓨터 실행시간 (uptime 명령어)

**2) load average** 

  - 시스템 부하정도를 나타내는 1분, 5분, 15분 시스템 부하평균값(EMA) 
...
1) 기본적인 매크로 사용 방법
   ...
   * 커맨드 모드 (esc 누른 상태) 에서 'q' 를 누르고 a~z 사이 문자로 매크로 recording 시작
 
   * 커맨드 모드로 돌아와서 'q'를 누르면 매크로 recording 끝
 
   * 매크로를 사용하려면 커맨드 모드에서 @+a~z 를 입력하면 됨
 
 
2) 자주 사용하는 매크로 등록 방법
